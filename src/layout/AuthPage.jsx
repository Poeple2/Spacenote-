...
const ROLES = [
  ...
  { id: 'companies', label: 'Companies', icon: null },
  { id: 'delivery', label: 'Delivery Services', icon: null, onRightPanel: true }, 
...
const INTERESTS = [
  { id: 'news', label: 'News', color: '#f7ca6d' },
  { id: 'technology', label: 'Technology', color: '#0072c6' },
  { id: 'product', label: 'Product & Innovation', color: '#e5e5e5' },
  { id: 'business', label: 'Business', color: '#00b050' },
  { id: 'sports', color: '#e5e5e5', label: 'Sports' },
  { id: 'gaming', label: 'Gaming', color: '#7030a0' },
  { id: 'entertainment', label: 'Entertainment', color: '#e5e5e5' },
  { id: 'music', label: 'Music', color: '#ff0000' },
  { id: 'culture', label: 'Culture', color: '#f2c9e6' },
  { id: 'society', label: 'Society', color: '#add8e6' },
  { id: 'travel', label: 'Travel', color: '#000000' },
  { id: 'careers', label: 'Careers', color: '#c0501f' },
  { id: 'lifestyle', label: 'Lifestyle', color: '#e5e5e5' },
  { id: 'family', label: 'Family', color: '#0070c0' },
  { id: 'family2', label: 'Family', color: '#da70d6' },
];
...
export default function AuthPage({ onAuth }) {
  ...
  // ── ÉCRAN DE SUCCÈS (VERIFIED - image_e516b8.png) ──
  if (isProcessing && isVerified) {
    return (
      <div style={S.page}>
        <CentralLogo />
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', width: '340px', marginBottom: '24px' }}>
                ...
                <div style={{ position: 'relative', width: '100%' }}>
                  ...
                  <div style={{
                    ...
                    width: '20px', height: '20px', border: '1px solid #cccccc', borderRadius: '3px'
                  }} />
                </div>
...
>
  ...
  maxWidth: '340px'
          ...
          <div style={S.panelGray}>
            ...
            {isRoleDropdownOpen && (
              <div 
                onClick={() => selectRoleOption('Delivery Services')}
                style={{ 
                  position: 'absolute',
                  left: '60px', 
                  bottom: '120px', 
              ...
              >
                <span style={{ fontSize: '20px', fontWeight: '500', color: '#000000' }}>
                  Delivery Services
                </span>
              </div>
            )}
